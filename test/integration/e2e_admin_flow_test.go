...
func setupE2EAdminRouter(t *testing.T, app *testutil.TestApp) *gin.Engine {
	...
	updateUserStatusCmd := adminuser.NewUpdateUserStatusCommand(app.Container.UserRepository, app.Container.AuditLogRepository, app.Logger)
	updateUserRoleCmd := adminuser.NewUpdateUserRoleCommand(app.Container.UserRepository, app.Container.AuditLogRepository, app.Logger)
	...
	startInstanceCmd := adminxray.NewStartInstanceCommand(app.Container.XrayInstanceRepository, app.Container.XrayProcessManager, app.Container.AuditLogRepository, app.Logger)
	stopInstanceCmd := adminxray.NewStopInstanceCommand(app.Container.XrayInstanceRepository, app.Container.XrayProcessManager, app.Container.AuditLogRepository, app.Logger)
	restartInstanceCmd := adminxray.NewRestartInstanceCommand(app.Container.XrayInstanceRepository, app.Container.XrayProcessManager, app.Container.AuditLogRepository, app.Logger)
	reloadInstanceCmd := adminxray.NewReloadInstanceCommand(app.Container.XrayInstanceRepository, app.Container.XrayProcessManager, app.Container.AuditLogRepository, app.Logger)
	checkInstanceHealthCmd := adminxray.NewCheckInstanceHealthCommand(app.Container.XrayInstanceRepository, app.Container.XrayProcessManager)
	...
	createInboundCmd := admininbound.NewCreateInboundCommand(app.Container.InboundRepository, app.Container.XrayInstanceRepository, app.Container.RealityConfigRepository, app.Container.AuditLogRepository, app.Logger)
	updateInboundCmd := admininbound.NewUpdateInboundCommand(app.Container.InboundRepository, app.Container.AuditLogRepository, app.Logger)
	deleteInboundCmd := admininbound.NewDeleteInboundCommand(app.Container.InboundRepository, app.Container.ClientRepository, app.Container.AuditLogRepository, app.Logger)
	enableInboundCmd := admininbound.NewEnableInboundCommand(app.Container.InboundRepository, app.Container.AuditLogRepository, app.Logger)
	disableInboundCmd := admininbound.NewDisableInboundCommand(app.Container.InboundRepository, app.Container.AuditLogRepository, app.Logger)
	...
	createClientCmd := adminclient.NewCreateClientCommand(app.Container.ClientRepository, app.Container.InboundRepository, app.Container.UserRepository, app.Container.AuditLogRepository, app.Logger)
	deleteClientCmd := adminclient.NewDeleteClientCommand(app.Container.ClientRepository, app.Container.AuditLogRepository, app.Logger)
	enableClientCmd := adminclient.NewEnableClientCommand(app.Container.ClientRepository, app.Container.AuditLogRepository, app.Logger)
	disableClientCmd := adminclient.NewDisableClientCommand(app.Container.ClientRepository, app.Container.AuditLogRepository, app.Logger)
